...
function Profile() {
  ...
  const handleOnSubmit: SubmitHandler<UserDetails> = (data) => {
    setError(null)
    ...
    <ProfileLayout>
      ...
      <div className='isolate bg-white px-6 lg:px-8'>
        <div className='mx-auto max-w-2xl relative text-center'>
          ...
          <p className='mt-2 text-lg leading-8 text-gray-600'>Update your profile</p>
        ...
        <form onSubmit={handleSubmit(handleOnSubmit)} className='mx-auto mt-16 max-w-xl sm:mt-20'>
          <div className='grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2'>
            <div>
              ...
              <div className='mt-2.5'>
                <input
                  {...(editMode ? { ...register('name') } : { disabled: true })}
                  type='text'
                  id='first-name'
                  autoComplete='off'
                  className={classNames(
                    errors.name ? 'ring-red-600 rounded-md focus:ring-red-600' : 'ring-gray-300 focus:ring-indigo-600',
            ...
            <div>
              ...
              <div className='mt-2.5'>
                <input
                  {...(editMode ? { ...register('fullName') } : { disabled: true })}
                  type='text'
                  id='full-name'
                  autoComplete='off'
                  className={classNames(
            ...
            <div className='sm:col-span-2'>
              ...
              <div className='mt-2.5'>
                <input
                  {...(editMode ? { ...register('email') } : { disabled: true })}
                  type='email'
                  autoComplete='off'
                  id='email'
                  className={classNames(
                    errors.email ? 'ring-red-600 rounded-md focus:ring-red-600' : 'ring-gray-300 focus:ring-indigo-600',
                    'block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6',
                  )}
                />
              </div>
            ...
            <div className='sm:col-span-2'>
              ...
              <div className='relative mt-2.5'>
                <input
                  {...(editMode ? { ...register('phone') } : { disabled: true })}
                  type='tel'
                  id='phone'
                  autoComplete='off'
                  className={classNames(
                    errors.phone ? 'ring-red-600 rounded-md focus:ring-red-600' : 'ring-gray-300 focus:ring-indigo-600',
                    'block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6',
                  )}
                />
              </div>
            ...
            {/* <div className='sm:col-span-2'>
              ...
              <div className='mt-2.5'>
                <div className='relative flex items-center'>
                  ...
                  <input
                    {...(editMode ? { ...register('website') } : { disabled: true })}
                    type='text'
                    autoComplete='off'
                    className={classNames(
                      errors.website
            ...
            {/* <div className='sm:col-span-2'>
              ...
              <div className='mt-2.5'>
                <textarea
                  {...(editMode ? { ...register('about') } : { disabled: true })}
                  name='message'
                  autoComplete='off'
                  rows={4}
                  className={classNames(
                    errors.about ? 'ring-red-600 rounded-md focus:ring-red-600' : 'ring-gray-300 focus:ring-indigo-600',
                    'block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6',
                  )}
                  defaultValue={''}
                />
          ...
          <div className='mt-10'>
            <button
              ...
              type='submit'
              className={`${editMode ? 'bg-indigo-600 hover:bg-indigo-500' : 'bg-gray-400 cursor-not-allowed'} ${
                error ? ' ring-1 ring-opacity-40 ring-red-700 ring-offset-2' : ''
